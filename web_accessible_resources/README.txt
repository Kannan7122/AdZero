...
Any fetch operation made without AdZero AdBlocker's internal secret will result
...
Only AdZero AdBlocker knows the secret token at runtime and hence only
AdZero AdBlocker can access the content of this folder.
